...
SUBMIT = ROOT / "image/profile-overlay/airootfs/usr/lib/clawos/clawos-agent-submit"
RUNNER = ROOT / "image/profile-overlay/airootfs/usr/lib/clawos/clawos-agent-run"
REQUEST = ROOT / "image/profile-overlay/airootfs/usr/lib/clawos/clawos-agent-request"
