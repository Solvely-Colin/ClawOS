...
| 2026-09-12 | `042dbc7b8b7c36c668a727a0ec07f806227538f4` | `d267ecf1ce91e0567c5143cd728ad7bef2fe340aba43c074673f6d7bb122a042` | clean private release-compressed Linux VM build; Windows transfer hash matched | source/image validation and fresh diskless live boot; root-owned verifier not writable by group/others matched the source checksum, runtime/config/lock version and commit/hash pins matched, lifecycle marker absent before CLI execution, OpenClaw reported `2026.8.2 (0965053)` | Windows QEMU/WHPX, Q35/OVMF, 8 GiB RAM, isolated firmware | `CLAWOS_INTEGRITY_IMAGE_SMOKE_PASS`; no install, onboarding, inference or physical-hardware claim | ISO, SHA-256, build/serial logs and private host launcher retained; no tag, release or public binary upload |

| 2026-09-13 (UTC) | `f2da7a68753c0e6df418108797b4a8fee186e833` | `e141a464244bb6585fead5e0ac3dd83bbe6c113d8eff243c6856791bdb39deda` | clean private release-compressed Linux VM build; source/image validation and Windows transfer hash passed | first graphical passwordless attempt stopped progressing during package retrieval; recovery showed virtio-net transmit-queue watchdog timeouts; target still blank | Windows QEMU/WHPX, Q35/OVMF, 8 GiB, 40 GiB virtio disk, virtio-net NIC | network attempt failed; normal ACPI shutdown, task exit 0; offline comparison found the entire target identical to a fresh blank reference | build/serial logs, image/checksum and blank checkpoint retained privately |
| 2026-09-13 (UTC) | `f2da7a68753c0e6df418108797b4a8fee186e833` | `e141a464244bb6585fead5e0ac3dd83bbe6c113d8eff243c6856791bdb39deda` | same unchanged private ISO | GTK passwordless install, normal installer restart, disk-only boot, local gateway and non-default approval policy, native provider wizard launch/cancel from onboarding, explicit model-later workspace entry, terminal launch/return; both corrected launchers root:root 0755 and policy persisted | Windows QEMU/WHPX, Q35/OVMF, 8 GiB, same verified blank 40 GiB disk; host NIC changed to e1000e; 1440x900 1:1 viewer | passed these paths without runtime repair; no provider credentials, inference, encrypted install, visible Polkit dialog or hardware qualification | private image/hash, build/serial logs, browser observations, workspace screenshot and disk/firmware checkpoints; no release/tag/ISO upload |
| 2026-09-13 (UTC) | `f2da7a68753c0e6df418108797b4a8fee186e833` | `e141a464244bb6585fead5e0ac3dd83bbe6c113d8eff243c6856791bdb39deda` | same unchanged private ISO | encrypted CLI install to a separately checkpointed blank disk using a random DPAPI-protected throwaway passphrase; disk-only firmware boot and QEMU-input unlock; encrypted Btrfs root, absence of passwordless marker, corrected launchers, services and key-only SSH checks; default Full Root onboarding, native provider wizard launch/cancel, explicit model-later workspace entry | Windows QEMU/WHPX, Q35/OVMF, 8 GiB, separate 40 GiB virtio disk, e1000e NIC, scaled loopback VNC viewer | passed these bounded paths; passphrase never printed or recorded in serial evidence; installer was CLI rather than GTK passphrase submission; no provider authentication, inference, visible Polkit dialog or physical hardware | private DPAPI secret, ISO/hash, build/serial logs and disk/firmware checkpoints; no release/tag/ISO upload |

| 2026-09-14 (UTC) | `53fc35ef3742e5be0af5a607c0fb9796c48539ee` | `be54d430f8438fbd5fae9053180594dbb2f749e19fd3a2a18d79fdb12d379804` | clean private release-compressed Linux VM build from the exact branch commit | full source preflight and image validation; actual installed OpenClaw tree produced 331 package paths / 328 unique name-version SBOM components, 316 collected license texts, zero unknown license declarations, valid non-blocking audit JSON, and SHA256SUMS verification for ISO/SBOM/audit/status/license manifest | Windows-managed Linux builder VM, dedicated virtio build volume | build and inventory validation passed; audit snapshot reported zero known vulnerabilities at build time, which is not a guarantee or a transitive lock; image was not booted or installed | private SBOM, audit, manifest, checksums and build log retained; ISO remains only on the private builder volume; no tag, release or public artifact |

| 2026-09-15 (UTC) | `82d0cc7364b884b944c1af68726386bf71142b17` | `086bdb42e1067d3f3bdfaecedd014033bb4c907ad4d1ea6366fda6d0191e89c1` | `release.yml` run 34922094645 using pinned `archlinux:base-devel@sha256:70d777aa…bb7844` | clean build, inventory validation, live KVM boot, passwordless install/disk-only boot, ACPI shutdowns; GitHub provenance attested ISO, SHA256SUMS and SBOM | GitHub-hosted Ubuntu runner, pinned privileged Arch container, QEMU/KVM | passed; `gh attestation verify SHA256SUMS --repo Solvely-Colin/ClawOS` bound the subjects to this repository/workflow/SHA and GitHub-hosted runner using checksum-verified GitHub CLI 2.100.0 | scanned boot/install evidence retained for 14 days; `retain_iso=false`, so ISO artifact and attestation bundle were not uploaded as a downloadable artifact; attestation remains in GitHub's attestation service; private verification JSON retained |
| 2026-09-15 (UTC) | `9c206cc650e3f51c8559c4f2908d24890311f032` | `6d5c7316266c7c0d3c9d7bcd01dec0f1210c435d859bc85faf624e3f86744c27` | `release.yml` run 34991750229 | clean build and live KVM boot; eligible-target list with blank control plus GPT/ext4, mounted-ext4 and ISO targets; dry-run then real refusal for each unsafe target; exact `sfdisk -d`/descendant `blkid` snapshots; normal passwordless install and disk-only boot | GitHub-hosted Ubuntu runner, pinned privileged Arch container, QEMU/KVM, Q35/OVMF | passed: only `/dev/vda` eligible; all six unsafe-target attempts exited 1 before package-preparation/write markers; each before/after snapshot hash matched; three QCOW2 checks and all ACPI shutdowns passed | scanned evidence artifact 10407495300 retained for 14 days; `retain_iso=false`, so no ISO artifact was uploaded; full refusal record in HARDWARE-INSTALLER-VALIDATION.md |
| 2026-09-15 (UTC) | `2632fd69a5dd3d08245a527f85035f285f4fef67` | `3710f193629fa968c91ceb2055d7f2c8981312e460ecec2864679113e4d89863` | clean private fast build in the persistent Linux builder; Windows transfer hash matched | fresh online and no-NIC live boots; pinned `2026/08/25` archive readiness on welcome and Install screens; event/status consistency; actionable offline DNS reason; Erase disabled; blank-target comparison | Windows QEMU/WHPX, Q35/OVMF, 8 GiB, fresh firmware per state, 40 GiB virtio disk, 1440x900 | passed: online state and event both reachable with green install card; offline state and event both unreachable with one failure card; no installer invocation; target remained logically identical to a fresh blank QCOW2; ACPI exits returned task result 0 | private ISO/checksum, serial logs and screenshots retained locally; no tag, release or public ISO artifact; full record in HARDWARE-INSTALLER-VALIDATION.md |
| 2026-09-15 (UTC) | `155f3a107ced085be5fe309d9b8a76614bbf011a` | `e15334f6a56da2f63fe1d9e05ce97d078ac984df58b6c1de861c9b73620d6723` | clean private fast build on the persistent dedicated work volume; Windows transfer hash matched | graphical passwordless selection/confirmation and direct Erase click at 2 GiB; capacity result propagation; whole-QCOW2 before/after SHA-256 and logical comparison | Windows QEMU/WHPX, Q35/OVMF, 2 GiB, fresh 40 GiB virtio disk, e1000e, 1440x900 | passed: result visible within a 16.53-second polling upper bound; screen reported 1386 MiB required, 968 MiB free and minimum 4 GiB; before/after disk SHA-256 both `a4229cbb…2ab73`; `qemu-img compare` identical and image check clean; ACPI task result 0 | private ISO/checksum, serial log and screenshots retained locally; no tag, release or public artifact; full record in HARDWARE-INSTALLER-VALIDATION.md |
