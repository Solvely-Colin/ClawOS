...
from tracking with checksum-verified local preservation. That cleanup retained
history; the later owner-approved [public baseline reset](HISTORY.md) archives
the earlier branch history privately. Public architecture and repository-protection guidance
