...
Public Git history starts from an owner-approved clean baseline. Earlier test
records retain their original hashes; [history and archive notes](docs/HISTORY.md)
explain the boundary. Required third-party notices are preserved.
