# Milestone 4: full OpenClaw Node role
...
```bash
openclaw plugins install --link /path/to/ClawOS/m2/openclaw-plugin
...
- `m4/tests/role-switch.sh` proves successful switching and forced-failure
