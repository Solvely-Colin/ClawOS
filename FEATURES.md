...
| Terminal/browser/build surfaces | Task-specific windows, tmux sessions, browser profiles and prompt routing; separate drafts and two-task WHPX windows verified; dynamic browser-tool profile registration remains manual ([details](docs/TASK-SURFACES.md)) |
