...
| --- | --- |
| Arch-based live image and encrypted install | Development proof; installer restricted to QEMU/KVM Q35 |
...
| General physical hardware | Not supported by the current installer |
