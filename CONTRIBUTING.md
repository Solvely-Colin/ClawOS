...
After the [public baseline reset](docs/HISTORY.md), start from a fresh clone.
Do not merge an archived pre-reset branch into current history. Reapply reviewed
changes on a new branch; the one-time reset does not waive normal PR checks.
